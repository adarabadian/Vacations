...
server.get('/vacationsboard', (req,res) => {
    res.redirect('https://vacations.onrender.com/');
});
...
const io = socketIO(serverResult, {
  cors: {
    origins: ["https://vacations.onrender.com", "http://vacations.onrender.com"],
...
server.use(
    cors({ 
        origins: [
                    "https://vacations.onrender.com",
                    "http://vacations.onrender.com",
