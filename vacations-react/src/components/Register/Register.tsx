...
export default class Register extends Component <any, RegistrationState> {
    ...
    private isUserNameExists = async (event: any) => {
        ...
        try {
            ...
            const response =  await axios.post("https://vacations.onrender.com/users/isUserNameExists", userName);
    ...
    public registerNewUser = async () => {
        ...
        try {
            ...
            const response =  await axios.post<SuccessfulLoginServerResponse>("https://vacations.onrender.com/users/register", userRegistrationDetails);
            const serverResponse = response.data;
