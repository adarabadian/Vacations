...
export default class NewVacationModal extends Component<any, modalState>{
    ...
    private addNewVacation = async() => {
        ...
        try {
            ...
            const multerResponse = await axios.post("https://vacations.onrender.com/vacations/upload", data, {})
            this.state.vacationToAdd.picture = multerResponse.data.filename;

            // send new vacation to server
            let response = await axios.post("https://vacations.onrender.com/vacations/addNewVacation/",this.state.vacationToAdd);
