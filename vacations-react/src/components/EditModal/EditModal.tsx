...
export default class EditModal extends Component<any, modalState>{
    ...
    private saveVacationChanges = async () => {
        ...
        if (editedVacation.picture !== originalVacation.picture) {
            const res = await axios.post("https://vacations.onrender.com/vacations/upload", data, {});
        ...
        try {
            ...
            await axios.post("https://vacations.onrender.com/vacations/editVacation/",editedVacation);
